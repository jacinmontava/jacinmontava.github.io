...
$(function () {
    ...
    if ($contact_form.length > 0) {
        ...
        $contact_form.submit(function () {
            ...
            var $spam = $contact_form.find('.input-spam');
            if ($spam.val() != 525) {
            	$spam.addClass('input-error');
            }
            ...
            $.post($contact_form.attr('action'), {
                ...
                // vaciamos el form
                $contact_form.find('#contact_name').val('');
	            $contact_form.find('#contact_email').val('');
	            $contact_form.find('#contact_message').val('');
	            $contact_form.find('#spam_text').val('');
